...
<template>
    <div class="flex flex-col mt-2 w-full rounded-md">
        ...
        <div class="text-center mx-auto" @scroll="vListMarker" v-bind="containerProps" style="height:500px;">
            ...
            <div class="inline-block w-full" ref="vListRef" v-bind="wrapperProps">
                ...
                <section v-if="appStates.isDataContinuityOK" v-for="(item, ind) in list" :style="'height:'+iheight+'px;'" :key="'row'+ind" class="table-row [&>*]:sm:px-10 [&>*]:even:bg-[var(--color-background-mute)]">
