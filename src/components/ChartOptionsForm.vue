    ...
    <div class="min-w-[inherit] p-2 border border-[--color-border] rounded-lg bg-[--color-background-soft]">
        ...
        <form class="flex gap-1">
            <section class="flex w-full border border-[--color-border] bg-[--color-background-mute] p-2 rounded-lg">
                <label class="font-normal w-28 text-center italic sm:mr-2" for="yearFrom">from year  </label>
            ...
            <section class="flex w-full border border-[--color-border] bg-[--color-background-mute] p-2 rounded-lg">
                <label class="font-normal w-28 text-center italic sm:mr-2" for="yearTo">to year </label>
