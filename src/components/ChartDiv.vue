<template>
  <div class="mb-2 sm:mb-0 lg:mb-4">
    ...
    <div v-if="appStates.isChartShowing" class="fixed z-10 top-0 left-0 w-screen h-screen transition-all duration-300"
      id="curve_chart" ref="gcchart"></div>
    <button v-if="appStates.isChartShowing" @click="appStates.isChartShowing = false"
      class=" z-20 fixed top-0 right-0 m-4 lg:m-8">
      <ChartIconClose />
    </button>
  </div>
</template>
